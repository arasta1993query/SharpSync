...
{
    public static class Scaffolds
    {
        public static string GetAxiosScaffold()
        {
...
";
        ...
        public static string GetFetchScaffold()
        {
...
export const apiRequest = async <T>(
    ...
    if (params) {
        const query = serializeToQueryParams(params);
    ...
    if (!response.ok) {
        ...
        throw new SharpSyncError(errorData, response.status);
    }
